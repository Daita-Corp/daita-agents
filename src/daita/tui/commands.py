...
SLASH_COMMAND_COMPLETIONS = (
    ...
    (
        ...
        "Promote one successful run into a scheduled routine",
    ),
    (
        "/routines update ",
    ...
    ("/workspace", "/workspace", "Show local file access and working directory"),
    ("/files ", "/files <question>", "Run using local files only"),

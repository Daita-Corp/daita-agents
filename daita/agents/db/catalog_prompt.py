...
from .config.policies import SchemaPromptPolicy
...
def build_db_prompt_read_model(
    ...
    *,
    ...
    return DBPromptReadModel(
        ...
        relationship_lines=_render_relationships(foreign_keys, policy),
...
def _render_relationships(
    ...
    if len(foreign_keys) > relationship_limit:
        lines.append(
            f"- ... {len(foreign_keys) - relationship_limit} additional relationships available via catalog_find_join_paths"
        )
    return lines

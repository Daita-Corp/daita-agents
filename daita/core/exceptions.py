...
class AgentError(DaitaError):
    ...
    def __init__(self, message: str, agent_id: str = None, task: str = None,
                 retry_hint: str = "retryable", context: dict = None):
        super().__init__(message, retry_hint, self._enrich(context, agent_id=agent_id, task=task))
...
class ConfigError(DaitaError):
    ...
    def __init__(self, message: str, config_section: str = None, context: dict = None):
        super().__init__(message, "permanent", self._enrich(context, config_section=config_section))
...
class LLMError(DaitaError):
    ...
    def __init__(self, message: str, provider: str = None, model: str = None,
                 retry_hint: str = "retryable", context: dict = None):
        super().__init__(message, retry_hint, self._enrich(context, provider=provider, model=model))
...
class PluginError(DaitaError):
    ...
    def __init__(self, message: str, plugin_name: str = None,
                 retry_hint: str = "retryable", context: dict = None):
        super().__init__(message, retry_hint, self._enrich(context, plugin_name=plugin_name))
...
class WorkflowError(DaitaError):
    ...
    def __init__(self, message: str, workflow_name: str = None,
                 retry_hint: str = "retryable", context: dict = None):
        super().__init__(message, retry_hint, self._enrich(context, workflow_name=workflow_name))
...
class RoutingError(DaitaError):
    ...
    def __init__(self, message: str, task: str = None, available_agents: list = None,
                 retry_hint: str = "retryable", context: dict = None):
...
class RateLimitError(TransientError):
    ...
    def __init__(self, message: str = "Rate limit exceeded",
                 retry_after: int = None, context: dict = None):
        if retry_after:
...
class TimeoutError(TransientError):
    ...
    def __init__(self, message: str = "Operation timed out",
                 timeout_duration: float = None, context: dict = None):
        if timeout_duration:
            message = f"{message} (after {timeout_duration}s)"
        super().__init__(message, self._enrich(context, timeout_duration=timeout_duration))
...
class ConnectionError(TransientError):
    ...
    def __init__(self, message: str = "Connection failed",
                 host: str = None, port: int = None, context: dict = None):
        if port:
...
class ServiceUnavailableError(TransientError):
    ...
    def __init__(self, message: str = "Service temporarily unavailable",
                 service_name: str = None, context: dict = None):
        if service_name:
...
class ResourceBusyError(RetryableError):
    ...
    def __init__(self, message: str = "Resource is busy",
                 resource_name: str = None, context: dict = None):
        if resource_name:
...
class DataInconsistencyError(RetryableError):
    ...
    def __init__(self, message: str = "Data inconsistency detected",
                 data_source: str = None, context: dict = None):
...
class ProcessingQueueFullError(RetryableError):
    ...
    def __init__(self, message: str = "Processing queue is full",
                 queue_name: str = None, context: dict = None):
...
class AuthenticationError(PermanentError):
    ...
    def __init__(self, message: str = "Authentication failed",
                 provider: str = None, context: dict = None):
...
class PermissionError(PermanentError):
    ...
    def __init__(self, message: str = "Permission denied",
                 resource: str = None, action: str = None, context: dict = None):
        super().__init__(message, self._enrich(context, resource=resource, action=action))
...
class ValidationError(PermanentError):
    ...
    def __init__(self, message: str = "Validation failed",
                 field: str = None, value: str = None, context: dict = None):
...
class InvalidDataError(PermanentError):
    ...
    def __init__(self, message: str = "Invalid data format",
                 data_type: str = None, expected_format: str = None, context: dict = None):
        super().__init__(message, self._enrich(context, data_type=data_type, expected_format=expected_format))
...
class DataQualityError(PermanentError):
    ...
    def __init__(self, message: str = "Data quality violation",
                 violations: list = None, table: str = None, context: dict = None):
        super().__init__(message, self._enrich(context, table=table, violations=violations))
...
class NotFoundError(PermanentError):
    ...
    def __init__(self, message: str = "Resource not found",
                 resource_type: str = None, resource_id: str = None, context: dict = None):
        super().__init__(message, self._enrich(context, resource_type=resource_type, resource_id=resource_id))
...
class BadRequestError(PermanentError):
    ...
    def __init__(self, message: str = "Bad request",
                 request_type: str = None, context: dict = None):
...
class CircuitBreakerOpenError(PermanentError):
    ...
    def __init__(self, message: str = "Circuit breaker is open",
                 agent_name: str = None, failure_count: int = None, context: dict = None):
        super().__init__(message, self._enrich(context, agent_name=agent_name, failure_count=failure_count))
...
class BackpressureError(RetryableError):
    ...
    def __init__(self, message: str = "Backpressure limit exceeded",
                 agent_id: str = None, queue_size: int = None, context: dict = None):
        if queue_size is not None:
            message = f"{message} (queue size: {queue_size})"
        super().__init__(message, self._enrich(context, agent_id=agent_id, queue_size=queue_size))
        self.agent_id = agent_id
...
class TaskTimeoutError(TransientError):
    ...
    def __init__(self, message: str = "Task execution timed out",
                 task_id: str = None, timeout_duration: float = None, context: dict = None):
        if timeout_duration:
            message = f"{message} after {timeout_duration}s"
        super().__init__(message, self._enrich(context, task_id=task_id, timeout_duration=timeout_duration))
...
class AcknowledgmentTimeoutError(TransientError):
    ...
    def __init__(self, message: str = "Message acknowledgment timed out",
                 message_id: str = None, timeout_duration: float = None, context: dict = None):
        super().__init__(message, self._enrich(context, message_id=message_id, timeout_duration=timeout_duration))
...
class ReliabilityConfigurationError(PermanentError):
    ...
    def __init__(self, message: str = "Invalid reliability configuration",
                 config_key: str = None, context: dict = None):
        if config_key:
...
class DeadLetterQueueError(RetryableError):
    ...
    def __init__(self, message: str = "Dead letter queue operation failed",

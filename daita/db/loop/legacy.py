"""Legacy planner/compiler loop retained for out-of-scope non-SQLite connectors."""
...
class DbLegacyAgentLoop:
    """Planner-driven loop retained only until later connector cutovers."""

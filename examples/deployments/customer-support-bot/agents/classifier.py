...
async def classify_ticket(subject: str, body: str) -> Dict[str, Any]:
    ...
    billing_keywords = {
        ...
        "price", "cost", "fee", "credit card", "overcharge", "receipt",
        "trial", "plan", "upgrade", "downgrade", "cancel",
    }
    technical_keywords = {
        "error", "bug", "crash", "broken", "not working", "fail", "issue",
        "problem", "login", "access", "api", "timeout", "500", "403", "404",
        "performance", "slow", "outage", "down", "exception", "traceback",
        "integration", "webhook", "token", "authentication",
    }

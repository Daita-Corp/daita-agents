"""Ask one grounded question of a cataloged SQLite source with the v2 Agent."""
    ...
    with example_root(arguments.root, "quickstart") as root:
        ...
        try:
            ...
            model.extend(
                ...
                final_response("There are 3 orders.", "evidence-1"),
            )
            ...
            print(f"operation: {result.operation_id} ({result.kind.value})")
        finally:
            await agent.close()

            ...
            report.update(
                {
                    ...
                    "harness_sha256": hashlib.sha256(
                        b"".join(
                            ...
                            for name in (
                                "tests/support/mcp_routine_harness.py",
                                "tests/support/mcp.py",
                                "tests/support/job_benchmarks.py",
                                "tests/live/mcp/test_actions.py",
                                "tests/live/routines/test_mcp_actions.py",
                            )
                        )
                    ).hexdigest(),
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        raise SystemExit(
            "Usage: python -m tests.support.mcp_routine_harness REPORT_DIRECTORY"
        )

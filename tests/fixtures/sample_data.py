                        ...
                        "teams": [
                            {
                                "name": "Backend",
                                "members": [
                                    {"name": "Alice", "role": "Senior Engineer", "skills": ["Python", "PostgreSQL"]},
                                    {"name": "Bob", "role": "Engineer", "skills": ["JavaScript", "MongoDB"]}
                                ],
                                "projects": [
                                    {"name": "API Redesign", "status": "in_progress", "priority": "high"},
                                    {"name": "Database Migration", "status": "completed", "priority": "medium"}
                                ]
                            }
                        ]
                    }

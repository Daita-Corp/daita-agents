...
Examples:
    DAITA_RUN_LIVE_LLM=1 OPENAI_API_KEY=sk-... pytest \
        tests/integration/evals/test_evals_live.py \
...
async def test_eval_plain_live_agent_smoke(tmp_path):
    ...
    config = EvalSuiteConfig(
        ...
        agent={
            "factory": "tests.integration.evals.eval_live_factories:create_plain_live_agent"
        },
        cases=[
            {
                "id": "simple-answer",
...
async def test_eval_live_tool_calling_agent(tmp_path):
    ...
    config = EvalSuiteConfig(
        ...
        agent={
            "factory": "tests.integration.evals.eval_live_factories:create_tool_live_agent"
        },
        cases=[
            {
                "id": "multiply",
...
async def test_eval_live_skill_and_plugin_spans(tmp_path):
    ...
    config = EvalSuiteConfig(
        ...
        agent={
            "factory": "tests.integration.evals.eval_live_factories:create_skill_plugin_live_agent"
        },
        cases=[
            {
...
async def test_eval_live_sqlite_data_agent(tmp_path):
    ...
    config = EvalSuiteConfig(
        ...
        agent={
            "factory": "tests.integration.evals.eval_live_factories:create_sqlite_sales_agent",
...
async def test_eval_live_non_sql_data_operation_inspectors(tmp_path):
    ...
    config = EvalSuiteConfig(
        ...
        agent={
            "factory": "tests.integration.evals.eval_live_factories:create_data_ops_live_agent"
        },
        cases=[
            {
                "id": "data-services",

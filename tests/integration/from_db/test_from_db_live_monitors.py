...
driven monitor planning and lifecycle management are covered in the Bucket 4
prompt-monitor suite; these cases exercise the persisted scheduler, live
PostgreSQL observation, live LLM analysis/report synthesis, governance,
approval resume, and delivery capability paths owned by ``DbRuntime``.
"""

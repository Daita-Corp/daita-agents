...
Run examples:
    OPENAI_API_KEY=sk-... pytest tests/integration/test_from_db_phase6_live.py -v -s
    DAITA_FROM_DB_PHASE6_MODELS=gpt-4o-mini,gpt-4.1-mini pytest \
      tests/integration/test_from_db_phase6_live.py -v -s -m "requires_llm and requires_db"
"""
...
from ._harness import start_container

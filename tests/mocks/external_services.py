...
class MockSlackClient:
    ...
    async def upload_file(self, channels: str, file_content: Any, filename: str) -> Dict[str, Any]:
        """Mock file upload."""
        upload_info = {
...
class MockRESTClient:
    ...
    async def _make_request(self, method: str, path: str, data: Any = None, **kwargs) -> Dict[str, Any]:
...
@asynccontextmanager
async def mock_database(db_type: str = "postgresql") -> AsyncContextManager[MockDatabaseConnection]:

...
USER_EVENTS = [
    {"event_id": "E001", "user_id": "u100", "plan": "free",  "event": "signup",        "page": None,          "feature": None,         "session_id": "s-1", "ts": "2024-03-05T08:00:00Z", "device": "mobile",  "country": "US", "referrer": "google"},
    {"event_id": "E002", "user_id": "u100", "plan": "free",  "event": "page_view",     "page": "/dashboard",  "feature": None,         "session_id": "s-1", "ts": "2024-03-05T08:01:00Z", "device": "mobile",  "country": "US", "referrer": None},
    {"event_id": "E003", "user_id": "u100", "plan": "free",  "event": "feature_click", "page": "/dashboard",  "feature": "export",     "session_id": "s-1", "ts": "2024-03-05T08:02:00Z", "device": "mobile",  "country": "US", "referrer": None},
    {"event_id": "E004", "user_id": "u100", "plan": "free",  "event": "upgrade_prompt","page": "/upgrade",    "feature": "export",     "session_id": "s-1", "ts": "2024-03-05T08:03:00Z", "device": "mobile",  "country": "US", "referrer": None},
    {"event_id": "E005", "user_id": "u100", "plan": "free",  "event": "upgrade_start", "page": "/checkout",   "feature": None,         "session_id": "s-1", "ts": "2024-03-05T08:04:00Z", "device": "mobile",  "country": "US", "referrer": None},
    {"event_id": "E006", "user_id": "u100", "plan": "pro",   "event": "upgrade_complete","page": "/checkout", "feature": None,         "session_id": "s-1", "ts": "2024-03-05T08:05:00Z", "device": "mobile",  "country": "US", "referrer": None},
    {"event_id": "E007", "user_id": "u200", "plan": "pro",   "event": "signup",        "page": None,          "feature": None,         "session_id": "s-2", "ts": "2024-03-05T09:00:00Z", "device": "desktop", "country": "DE", "referrer": "direct"},
    {"event_id": "E008", "user_id": "u200", "plan": "pro",   "event": "page_view",     "page": "/dashboard",  "feature": None,         "session_id": "s-2", "ts": "2024-03-05T09:01:00Z", "device": "desktop", "country": "DE", "referrer": None},
    {"event_id": "E009", "user_id": "u200", "plan": "pro",   "event": "feature_click", "page": "/reports",    "feature": "analytics",  "session_id": "s-2", "ts": "2024-03-05T09:05:00Z", "device": "desktop", "country": "DE", "referrer": None},
    {"event_id": "E010", "user_id": "u300", "plan": "free",  "event": "signup",        "page": None,          "feature": None,         "session_id": "s-3", "ts": "2024-03-05T10:00:00Z", "device": "desktop", "country": "JP", "referrer": "twitter"},
    {"event_id": "E011", "user_id": "u300", "plan": "free",  "event": "page_view",     "page": "/dashboard",  "feature": None,         "session_id": "s-3", "ts": "2024-03-05T10:01:00Z", "device": "desktop", "country": "JP", "referrer": None},
    {"event_id": "E012", "user_id": "u300", "plan": "free",  "event": "churn",         "page": None,          "feature": None,         "session_id": "s-3", "ts": "2024-03-05T10:30:00Z", "device": "desktop", "country": "JP", "referrer": None},
]

TRANSACTIONS = [
    {"txn_id": "T001", "account_id": "ACC-100", "amount": 42.50,   "currency": "USD", "type": "purchase",    "merchant": "Amazon",           "merchant_category": "retail",    "country": "US", "ts": "2024-03-05T08:10:00Z", "flagged": False, "device_fingerprint": "fp-aaa", "ip": "1.2.3.4",   "velocity_1h": 1,  "card_present": True},
    {"txn_id": "T002", "account_id": "ACC-100", "amount": 9850.00, "currency": "USD", "type": "transfer",    "merchant": None,               "merchant_category": None,        "country": "RU", "ts": "2024-03-05T08:11:00Z", "flagged": True,  "device_fingerprint": "fp-zzz", "ip": "195.3.3.3", "velocity_1h": 12, "card_present": False},
    {"txn_id": "T003", "account_id": "ACC-200", "amount": 15.00,   "currency": "USD", "type": "purchase",    "merchant": "Starbucks",        "merchant_category": "food",      "country": "US", "ts": "2024-03-05T09:00:00Z", "flagged": False, "device_fingerprint": "fp-bbb", "ip": "5.6.7.8",   "velocity_1h": 1,  "card_present": True},
    {"txn_id": "T004", "account_id": "ACC-200", "amount": 5200.00, "currency": "USD", "type": "purchase",    "merchant": "Electronics Plus", "merchant_category": "retail",    "country": "US", "ts": "2024-03-05T09:05:00Z", "flagged": True,  "device_fingerprint": "fp-bbb", "ip": "5.6.7.8",   "velocity_1h": 8,  "card_present": False},
    {"txn_id": "T005", "account_id": "ACC-300", "amount": 2.99,    "currency": "USD", "type": "subscription","merchant": "Netflix",          "merchant_category": "streaming", "country": "US", "ts": "2024-03-05T10:00:00Z", "flagged": False, "device_fingerprint": "fp-ccc", "ip": "9.10.11.12","velocity_1h": 1,  "card_present": False},
    {"txn_id": "T006", "account_id": "ACC-100", "amount": 1.00,    "currency": "USD", "type": "purchase",    "merchant": "Test Merchant",    "merchant_category": "other",     "country": "NG", "ts": "2024-03-05T08:15:00Z", "flagged": True,  "device_fingerprint": "fp-zzz", "ip": "195.3.3.3", "velocity_1h": 14, "card_present": False},
]
...
PRODUCT_CATALOGUE = [
    {"id": "SKU-001", "name": "Wireless Headphones Pro",
     ...
     "price": 149.99, "cost": 62.00, "margin": 0.587, "stock": 234,
    ...
    {"id": "SKU-002", "name": "Mechanical Keyboard TKL",
    ...
    {"id": "SKU-003", "name": "USB-C Hub 7-in-1",
     ...
     "price": 39.99, "cost": 14.20, "margin": 0.645, "stock": 512,
    ...
    {"id": "SKU-004", "name": "Desk Lamp LED",
     ...
     "price": 34.99, "cost": 11.80, "margin": 0.663, "stock": 8,
...
class TestEcommerceOrders:
    ...
    def test_top_orders_by_amount(self):
        ...
        assert list(result[0].keys()) == ["order_id", "customer_name", "product", "amount"]
    ...
    def test_refund_summary(self):
        result = apply_focus(
            ORDERS,
            "refunded == True | SELECT order_id, customer_name, amount, notes"
        )
        assert len(result) == 1
...
class TestAPIErrorLogs:
    ...
    def test_errors_by_service(self):
        ...
        result = apply_focus(
            errors,
            "GROUP BY service | SELECT service, COUNT(*) AS error_count"
        )
...
class TestUserEventFunnel:
    ...
    def test_converted_user_journey(self):
        ...
        events = [r["event"] for r in result]
        assert events == [
            "signup", "page_view", "feature_click",
            "upgrade_prompt", "upgrade_start", "upgrade_complete"
        ]
...
class TestProductCatalogue:
    ...
    def test_margin_report(self):
        result = apply_focus(
            PRODUCT_CATALOGUE,
            "SELECT id, name, price, margin | ORDER BY margin DESC"
        )
        assert len(result) == 4
    ...
    def test_supplier_consolidation(self):
        ...
        result = apply_focus(
            PRODUCT_CATALOGUE,
            "SELECT supplier.id, supplier.name, id, name"
        )
...
class TestTokenReduction:
    ...
    def test_all_scenarios_reduce_tokens(self):
        scenarios = [
            ...
            (USER_EVENTS,        "event in ['upgrade_prompt', 'upgrade_complete'] | SELECT user_id, event"),
        ...
        for data, dsl in scenarios:
            focused = apply_focus(data, dsl)
            assert _token_estimate(focused) < _token_estimate(data), (

...
async def test_offline_text_edit_report_captures_complete_workflow(
    ...
    import tests.support.local_text_edit_live as live_case
    ...
    await live_case.run_live_text_edit_scenario(tmp_path)
